    ...
    (err) => {
      if (err) {
        ...
        const body = {
          ...
          subject: "Order Update "+`${req.body.detail.invoice}`+ " Care In India",
          ...
          <p>Your order id <strong>${req.body.detail.invoice}</strong>   current status <strong>${req.body.status}</strong> </p>
            <p style="margin-top: 35px;">If you did not initiate this request, please contact us immediately at support@careinindia.com</p>
    
            <p style="margin-bottom:0px;">Thank you</p>
            <strong>Care In India Team</strong>
                 `,
        };
